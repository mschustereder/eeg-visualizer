...
while True:
    # hrprocessor = hr.HRProcessor(lslhandler, lslhandler.get_stream_by_name("HR_Polar H10 CA549123"), lslhandler.get_stream_by_name("RR_Polar H10 CA549123"))
    # print(hrprocessor.get_all_bio_vars())
    print(eegprocessor.get_available_eeg_data())
    print("\n\n\n\n")
